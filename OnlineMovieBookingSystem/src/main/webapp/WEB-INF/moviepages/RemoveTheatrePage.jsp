...
<jsp:include page="NavigationBar.jsp"></jsp:include>
		<form method="POST" action="removeTheatreFromDB" enctype="multipart/form-data">
			<h1 class="h3 font-weight-normal pt-3">Remove Theatre</h1>
		<hr style="border:1px solid black;"/>
			<input  class="form-control mt-2 mb-3" id="movieName" type="text" name="TheatreId" placeholder="Theatre id" required autofocus autocomplete="off"/>
